...
export default function ModernPortfolio() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          <div className="space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed font-light">
              ...
              technologies and intelligent automation solutions
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
                <p className="text-xl text-gray-200">
                  I'm a passionate developer from Nairobi who believes in the
                  power of technology to solve real-world problems.
                </p>
                <p>
                  My expertise spans the full development spectrum—from crafting
                  intuitive user interfaces with modern frameworks to building
                  robust backend systems and intelligent automation tools with
                  Python.
                </p>
                <p>
                  I thrive on turning complex challenges into elegant solutions,
                  whether it's building scalable web applications or creating
                  automation systems that streamline business processes.
                </p>
              </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        desc: "Node.js, FastAPI, GraphQL",
                      },
                      {
                        icon: Cpu,
                        title: "Python Automation",
                        desc: "Web Scraping, TTS, APIs",
                      },
                      {
                        icon: Cloud,
      ...
      <section
        id="skills"
        className="py-24 px-6 bg-gradient-to-b from-transparent to-white/5"
      >
              ...
              <div key={idx} className="group relative">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:shadow-2xl h-full">
                  <div className="flex items-center mb-6">
                    <div
                      className={`p-3 rounded-xl bg-${category.color}-500/20 border border-${category.color}-500/30`}
                    >
                      <category.icon
                  ...
                  <ul className="space-y-3">
                    {category.skills.map((skill, skillIdx) => (
                      ...
                      >
                        <Star
                          size={12}
                          className={`text-${category.color}-400 mt-1.5 fill-current`}
                        />
                        {skill}
                      </li>
                    ))}
            ...
            {[
              {
                ...
                description:
                  "A comprehensive inventory management platform with real-time synchronization across multiple locations. Features include automated stock tracking, multi-location support, and advanced analytics.",
                tech: [
                  "React",
                  "TypeScript",
                  "Node.js",
                ...
                color: "blue",
                link: "https://github.com/Musyonchez/StockSync-Client",
                featured: true,
              },
              {
                title: "Syntax Memory - Code Learning Platform",
                description:
                  "An interactive web application that helps developers improve their coding skills through memory-based exercises and gamified learning experiences.",
                tech: ["Python", "FastAPI", "Modern UI", "SQLite"],
                color: "green",
                link: "https://github.com/Musyonchez/syntax",
              },
              {
                title: "LibRead - Intelligent Web Novel Reader",
                description:
                  "Python automation tool that transforms web novels into audio experiences through intelligent scraping and text-to-speech conversion with chapter management.",
                tech: ["Python", "Web Scraping", "TTS", "Automation"],
                color: "yellow",
                link: "https://github.com/Musyonchez/libread",
              },
              {
                title: "Web Novel Collection",
                description:
                  "A creative writing project showcasing original stories including fantasy and sci-fi novels with regular updates and reader engagement features.",
                tech: ["Creative Writing", "Fantasy", "Sci-Fi", "Storytelling"],
                color: "purple",
                link: "https://github.com/Musyonchez/webnovel",
                featured: true,
              },
            ].map((project, idx) => (
              <div
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex flex-wrap gap-2 mb-8">
                      {project.tech.map((tech) => (
                        <span
                          key={tech}
                          className={`px-3 py-1 bg-${project.color}-500/20 border border-${project.color}-500/30 text-${project.color}-400 rounded-full text-sm`}
                        >
                          {tech}
                        </span>
                      ))}
      ...
      <section
        id="contact"
        className="py-24 px-6 bg-gradient-to-t from-white/5 to-transparent"
      >
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Ready to turn your ideas into reality? Whether you need a modern
              web application, custom automation tools, or want to discuss an
              innovative project, I'm here to help.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              >
                <contact.icon
                  className={`h-12 w-12 text-${contact.color}-400 mx-auto mb-4 group-hover:scale-110 transition-transform`}
                />
